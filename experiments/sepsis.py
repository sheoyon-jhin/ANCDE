...
def main(manual_seed=args.seed, intensity=args.intensity,                                                               # Whether to include intensity or not
         device='cuda', max_epochs=args.epoch, pos_weight=10, *,                         # training parameters
         model_name=args.model, hidden_channels=args.h_channels, hidden_hidden_channels=args.hh_channels, num_hidden_layers=args.layers,  # model parameters
         lr = args.lr, dry_run=False,
