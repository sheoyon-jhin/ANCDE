...
def main(
        manual_seed=args.seed,device='cuda', max_epochs=200, *,                                        # training parameters
         model_name=args.model, hidden_channels=args.h_channels, 
         hidden_hidden_channels=args.hh_channels, 
         num_hidden_layers=args.layers,lr=args.lr,
    ...
    if model_name in BASELINE_MODELS:
        ...
        # import pdb ; pdb.set_trace()
        return common.main(experiments,model_name,name, times, train_dataloader, val_dataloader, test_dataloader, device, new_make_model,
                        num_classes, max_epochs, lr,slope_check, kwargs, step_mode=step_mode,c1=args.c1,c2=args.c2,)
